...
VALIDATION_LR_DIR = "../data/iu_lr_images/train"  # Low-resolution validation folder
VALIDATION_HR_DIR = "../data/iu_hr_images/train"  # High-resolution validation folder
OUTPUT_DIR = "../data/train_SRGAN_results/"  # Directory to save super-resolved images
...
with open(os.path.join(OUTPUT_DIR, "srgan_metrics_log.txt"), "w") as log_file:
    ...
    for lr_image_name in sorted(os.listdir(VALIDATION_LR_DIR)):
        ...
        output_path = os.path.join(OUTPUT_DIR, f"SR_GAN_{lr_image_name}")
...
with open(os.path.join(OUTPUT_DIR, "srgan_metrics_log.txt"), "a") as log_file:
